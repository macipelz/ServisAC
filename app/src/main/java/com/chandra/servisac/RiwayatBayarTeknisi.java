...
public class RiwayatBayarTeknisi extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(RiwayatBayarTeknisi.this);
            ...
            public void onResponse(Call<List<ModelDataPembayaran>> call, Response<List<ModelDataPembayaran>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < jumlah; i++) {
                        if (response.body().get(i).getNama_teknisi().equals(id)) {
                    ...
                    adapter = new ListArrayBayar(RiwayatBayarTeknisi.this, R.layout.row_bayar, dataservis);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id){
        ...
        Intent intent = new Intent(RiwayatBayarTeknisi.this,DetailBayar.class);
