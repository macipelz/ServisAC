...
public class LoginTeknisi extends AppCompatActivity {
    ...
    Button btn_register, btn_login, btn_kon;
    ...
    private String url = Server.URLtek + "login.php";

    private static final String TAG = LoginTeknisi.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.loginteknisi);
        ...
        btn_kon = (Button) findViewById(R.id.btn_kon);
        ...
        if (session) {
            Intent intent = new Intent(LoginTeknisi.this, MainActivityTeknisi.class);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                intent = new Intent(LoginTeknisi.this, RegisterTeknisi.class);
                finish();
                startActivity(intent);
            }
        });

        btn_kon.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                intent = new Intent(LoginTeknisi.this, Login.class);
                finish();
                startActivity(intent);
            }
        });
