...
public class RiwayatServisTeknisi extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(RiwayatServisTeknisi.this);
            ...
            public void onResponse(Call<List<ModelDataServis>> call, Response<List<ModelDataServis>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < jumlah; i++) {
                        if (response.body().get(i).getHp_teknisi().equals(username)) {
                    ...
                    adapter = new ListArrayAdapter(RiwayatServisTeknisi.this, R.layout.row_riwayat, dataservis);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id){
        ...
        Intent intent = new Intent(RiwayatServisTeknisi.this,DetailServisTeknisi.class);
