...
public class Login extends AppCompatActivity {
    ...
    Button btn_register, btn_login, btn_tek;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_tek = (Button) findViewById(R.id.btn_tek);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //intent = new Intent(Login.this, Notif.class);
                finish();
                startActivity(intent);
            }
        });

        btn_tek.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                intent = new Intent(Login.this, LoginTeknisi.class);
                finish();
                startActivity(intent);
            }
        });
